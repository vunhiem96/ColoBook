...
import com.volio.coloringbook2.customview.bottom.MagicShapePath.CircleShape
import com.volio.coloringbook2.customview.bottom.MagicShapePath.PathDirection
...
class MorphBottomNavigationViewTopEdgeTreatment(private val bottomNavigationMenuView: BottomNavigationMenuView,
  ...
  lateinit var easyShapePath: com.volio.coloringbook2.customview.bottom.MagicShapePath

  var lastSelectedItem: Int = 0
  var selectedItem: Int = 0

  override fun getEdgePath(length: Float, interpolation: Float, shapePath: ShapePath) {
    easyShapePath = com.volio.coloringbook2.customview.bottom.MagicShapePath.Companion.create(0f, morphVerticalOffset, length, morphVerticalOffset)
